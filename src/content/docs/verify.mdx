...
description: How to verify Anonomi releases before installing, especially in high-risk environments.
---
...
Only trust releases from **official Anonomi channels**.
...
2. Open the app
3. Select the downloaded Anonomi APK
