...
> If you forget your password and lose access, recovery may not be possible unless you have a backup. Plan accordingly.

---

## Back up account

Saves an encrypted copy of your whole account — identity, contacts and messages — to a file you choose.

The app asks for your password, then shows a **30-digit recovery code**. The code is shown once, is never stored on the device, and cannot be shown again. You need both the file and the code to restore.

After a backup has been made, this setting shows **Last backup** with the date. Where the backup went is deliberately not recorded — a note of its whereabouts would answer the one question a search of the phone should not be able to answer.

> The app never deletes a backup file for you, **not even a panic wipe**. Move it off the phone yourself.
