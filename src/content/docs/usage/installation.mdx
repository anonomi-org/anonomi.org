...
- **Your account lives on your device.** If you uninstall the app or lose access to the device, a [backup](/docs/usage/backup-and-restore) is the only way to get it back.
