...
Anonomi Messenger supports **voice messages** in addition to text and images.  
...
- Available in **one-to-one conversations**, **Private Groups**, and **Open Groups**
...
For this reason, Anonomi Messenger treats voice as **higher-risk than text by default**.

---

## Optional voice distortion

Anonomi Messenger includes an **optional voice distortion mode** designed to reduce the risk of voice recognition.
...
- **[Walkie-Talkie mode](/docs/features/walkie-talkie)**
