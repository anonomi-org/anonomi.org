...
Anonomi Messenger includes a **panic workflow** designed for situations where you are under coercion, detention, or immediate risk.
...
- Local Anonomi Messenger account state may be **deleted or locked**  
...
Anonomi Messenger allows you to mark specific contacts as **panic contacts**.
...
The goal is to allow triggering **without navigating Anonomi Messenger itself**.
