...
Anonomi Messenger is built to keep working under pressure — when networks are **monitored, blocked, unreliable, or unsafe**.

This page is a high-level overview of how Anonomi Messenger communicates. For exact switches and step-by-step choices, use the linked docs below.
...
Anonomi Messenger supports multiple offline communication methods that do not rely on external infrastructure:
