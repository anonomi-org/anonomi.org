---
title: Stealth mode
description: Disguise Anonomi Messenger as an innocuous app and gate access behind a hidden unlock.
---
...
In Stealth Mode, Anonomi Messenger presents a **fully usable decoy interface**.
...
To reduce accidental discovery and limit brute-force attempts, the unlock action is **deliberately non-obvious**.
...
- A normal tap behaves like a regular calculator
