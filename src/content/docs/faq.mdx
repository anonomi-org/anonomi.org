...
- Via optional helper components (e.g., Postbox) that **do not act as message-reading servers**
...
Anonomi Messenger does not rely on central accounts or recovery servers. Nobody can recover your account for you, and there is nothing to ask for.

Since version 1.5.0 you can export your account to an encrypted file protected by a 30-digit recovery code, and restore it on another phone. You need **both** the file and the code.

Without a backup, losing the device or deleting the app means your account, keys and contacts are permanently lost. This is a tradeoff for decentralization.
